    ...
    Box(
        ...
        Column(
            ...
            OutlinedTextField(
                ...
                label = {
                    Text(
                        modifier = Modifier
                            .padding(1.dp),
                        text = stringResource(R.string.pesquisa_aluno),
                        fontSize = 18.sp
                    )
                },
                trailingIcon = {
            ...
            Row(
                ...
                Image(
                    contentDescription = "",
                    painter = painterResource(id = R.drawable.capelo),
                    modifier = Modifier
                        .width(35.dp)
                        .height(35.dp)
                )
                        ...
                        Row(
                            ...
                            Card(
                                ...
                                Box(
                                    ...
                                    Image(
                                        contentDescription = "",
                                        painter = painterResource(R.drawable.luana_fake),
                                        modifier = Modifier
                                            .width(50.dp)
                                            .height(50.dp)
                                    )
                        ...
                        Row(
                            ...
                            Card(
                                ...
                                Box(
                                    ...
                                    Image(
                                        contentDescription = "",
                                        painter = painterResource(R.drawable.fabiana_luz),
                                        modifier = Modifier
                                            .width(50.dp)
                                            .height(50.dp)
                                    )
                        ...
                        Row(
                            ...
                            Card(
                                ...
                                Box(
                                    ...
                                    Image(
                                        contentDescription = "",
                                        painter = painterResource(R.drawable.carlos_augusto),
                                        modifier = Modifier
                                            .width(50.dp)
                                            .height(50.dp)
                                    )
